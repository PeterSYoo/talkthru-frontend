	...
	return (
		<>
			...
			<div className='mt-3 flex flex-col items-center gap-3'>
				...
				{canSearch && (
					<button onClick={() => handleMatchUser(userId)} className='border border-gray-400 p-3'>
						Find User to Match
					</button>
				)}
			...
			<div className='h-screen w-full'>
				{/* Choose a Subject */}
				{selectedSubject === '' && <ChooseSubject setSubject={setSelectedSubject} />}
				{/* Choose Expertise */}
				{selectedExpertise === '' && (
					<>
						{selectedSubject !== '' && (
				...
				{/* Looking for User */}
				{isSearching && (
					<LookingForUser setExpertise={setSelectedExpertise} subject={selectedSubject} />
				)}
			</div>
		</>
	);
