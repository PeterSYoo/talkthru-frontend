export const ChooseSubject = () => {
  return (
    <>
      <div className="flex flex-col pt-[106px] px-[105px] gap-[82px] pb-[313px]">
        ...
        <div className="flex flex-wrap gap-[122px]">
          <button className="w-[216px] h-[216px] rounded-[11px] shadow-[0px_2px_5px_rgba(0,0,0,0.6)] flex justify-center items-center">
            <img
